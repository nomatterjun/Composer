//
//  UICollectionViewComposableLayout.swift
//  Composer
//
...
public final class UICollectionViewComposableLayout: UICollectionViewCompositionalLayout {
  ...
  public indirect enum Group {
    ...
    private var layoutParameters: (
      ...
      contentInsets: NSDirectionalEdgeInsets,
      innerGroup: UICollectionViewComposableLayout.Group?
    ) {
      switch self {
    ...
    public func make(with item: NSCollectionLayoutItem) -> NSCollectionLayoutGroup {
      let groupMaker = UICollectionViewComposableLayout.groupForAllVersions(direction: self.layoutParameters.direction)
